...
const Register = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-br from-purple-700 via-pink-600 to-blue-500">
      ...
      <div className="bg-black bg-opacity-10 mt-3 p-8 rounded-2xl shadow-2xl w-full max-w-sm text-white backdrop-blur-md border border-white border-opacity-20">
        <h2 className="text-4xl font-bagel text-center mb-6">REGISTER</h2>
